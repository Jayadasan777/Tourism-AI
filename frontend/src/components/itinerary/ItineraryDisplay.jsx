...
import RedBusLiveBookingSimulator from './RedBusLiveBookingSimulator';
...
const ItineraryDisplay = ({ itinerary, onRegenerate, onSave, loading }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Autonomous Live RedBus Booking Agent Modal */}
      <RedBusLiveBookingSimulator
      ...
      {/* Live AI Agent Autonomous Booking Simulator Modal */}
      <RedBusLiveBookingSimulator
        isOpen={showBookingModal}
        onClose={() => setShowBookingModal(false)}
        destination={destination}
